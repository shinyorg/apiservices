...
{
    public abstract class AbstractGooglePushProvider : IGooglePushProvider
    {
        const string FcmUrl = "https://fcm.googleapis.com/fcm/send";
        readonly HttpClient httpClient = new HttpClient();

        public abstract GoogleNotification CreateNativeNotification(Notification notification);
        public abstract Task<bool> Send(string deviceToken, Notification notification, GoogleNotification native, CancellationToken cancelToken = default);
