...
namespace Shiny.Api.Push.Providers
{
    ...
    public class GoogleNotification
    {
        ...
        public GoogleAndroidConfig? Android { get; set; } = new GoogleAndroidConfig();
    }
    ...
    public class GoogleAndroidConfig
    {
        ...
        public GoogleAndroidNotificationDetails? Notification { get; set; } = new GoogleAndroidNotificationDetails();
    }
