...
{
    public abstract class AbstractApplePushProvider : IApplePushProvider
    {
        ...
        public abstract Task<bool> Send(string deviceToken, Notification notification, AppleNotification native, CancellationToken cancelToken = default);


        public virtual AppleNotification CreateNativeNotification(Notification notification)
        {
        ...
        protected virtual async Task<bool> Send(AppleConfiguration config, string deviceToken, Notification notification, AppleNotification native, CancellationToken cancelToken = default)
        {
